...
<div id="instructions3" style="display:none;">
    ...
    <ul>
        ...
        <li>An in-browser version of <a href="https://store.steampowered.com/app/897820/Reigns_Game_of_Thrones"><i>Reigns</i></a> where you play as major political figures in Chinese history.{%comment%}Draws directly from primary sources and Chinese-written biographies.{%endcomment%}</li>
    </ul>
</div>
