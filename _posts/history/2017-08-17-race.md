...
Post-Obama/Trump/COVID/Biden, there's been an interesting shift in U.S. racial dynamics. "Whiteness" is no longer a marker of high status.

But there is still stigma against non-American cultures. If we look at popular culture, every famous Hispanic actor has an Anglo name and no accent (e.g. [Oscar Isaac](https://en.wikipedia.org/wiki/Oscar_Isaac), [Tony Dalton](https://en.wikipedia.org/wiki/Tony_Dalton), [Michael Mando](https://en.wikipedia.org/wiki/Michael_Mando)). While Hispanic culture is looked down on, Hispanic people who embrace Anglo culture do fine.
