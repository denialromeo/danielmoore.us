...
Yet there is still stigma against non-American cultures. Resumes with non-white names are [routinely filtered out](https://www.nber.org/system/files/working_papers/w9873/w9873.pdf), and while most upper-class whites can be worked with, many HR departments, even at prestigious companies, are staffed by working-class white supremacists.
