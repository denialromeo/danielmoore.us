...
**12/30/2022 - While the below piece is largely correct, I'm not very satisfied with it. Too many Wikipedia links, too much conjecture, not enough sources, and the geopolitical landscape has changed so much since I wrote it in 2017 that the tone feels dated. A rewrite will take quite a bit of reading, but it's a worthwhile project.**
