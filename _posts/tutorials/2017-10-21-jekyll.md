...
* Get comfortable with a text editor. I like [Sublime Text](https://www.sublimetext.com/). [Atom](https://atom.io/) and [VSCode](https://code.visualstudio.com/) are good too.
