...
3. Use Scoop to install Git, Make, Ruby, and Wget, then configure your name and e-mail for Git.

    ```bash
    scoop install git make ruby wget
...
```bash
git clone "https://github.com/obaez/dentistsmile"
cd dentistsmile
...
* Get comfortable with a text editor. I like [Sublime Text](https://www.sublimetext.com/). [Atom](https://atom.io/) and [VSCode](https://code.visualstudio.com/) are good too. Consider learning [Vim](https://www.vim.org/).
